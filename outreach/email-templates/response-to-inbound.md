# Response to Inbound Investor Interest

**Use for**: When an investor reaches out first (e.g., Noro-Moseley)
**Tone**: Warm but measured — let them feel the momentum

---

## Template A — Response to Inbound Inquiry

**Subject**: Re: Dyrt Labs
...
## Template B — Response to Inbound (with Deck)

**Subject**: Re: Dyrt — deck + quick context

Hi [First],

Thanks for reaching out. Sending the deck and a quick note on where we are.
