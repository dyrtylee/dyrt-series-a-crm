# Lux Capital (historical pass record)
...
- **Reason**: No response
- **Re-engage?**: Currently being re-approached via Mucker (see the live Mucker sheet, "HARDTECH / INDUSTRIAL" section)
...
|------|------|-----------|-----------|
| — | — | No confirming email found for the original "no response" status | Track under the active Mucker-sourced approach instead |
